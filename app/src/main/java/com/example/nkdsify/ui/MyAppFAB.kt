...
fun MyAppFAB(
    ...
    if (myAppState.isShuffleButtonVisible && myAppState.currentScreen !is Screen.Trash && myAppState.currentScreen !is Screen.Settings && myAppState.currentScreen !is Screen.TagManagement && myAppState.currentScreen !is Screen.MediaByTag && myAppState.currentScreen !is Screen.SecretStorage) {
